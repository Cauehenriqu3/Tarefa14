export const users = [
    ...
    ,
    {
        id: '3',
        name: 'Palmeiras',
        description: 'O Clube de Futebol Palmeiras é um time de futebol brasileiro, fundado em 1914, na cidade de São Paulo. É um dos maiores e mais vitoriosos clubes do país, tendo vencido vários títulos nacionais e internacionais ao longo de sua história. O Palmeiras tem uma grande torcida e joga seus jogos em casa no estádio Allianz Parque.',
        image: {
            alt: 'SEP',
            src: 'https://logodownload.org/wp-content/uploads/2015/05/palmeiras-logo-0-2048x2048.png'
        }
    }
];
